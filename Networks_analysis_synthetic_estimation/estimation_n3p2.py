"""
This script reproduces the experiment of section 3.2 on parameter estimation in dimension (3,2).
...
- p is the number of orthonormal columns. In this experiment, p=2. (in the paper we denote by k)
